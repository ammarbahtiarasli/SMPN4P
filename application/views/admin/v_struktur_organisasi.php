...
<head>
  ...
  <title>SMPN 4 Pamarican | Struktur Organisasi</title>
          ...
          <div class="box-body">
            <table id="example1" class="table table-striped" style="font-size:13px;">
              ...
              <tr>
                ...
                <td>Perempuan</td>
                <?php endif;?>
                <td><?php echo $guru_jabatan;?></td>
                <td style="text-align:right;">
                      <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $id_jabatan;?>"><span class="fa fa-pencil"></span></a>
                      <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $id_jabatan;?>"><span class="fa fa-trash"></span></a>
                </td>
              </tr>
              <?php endforeach;?>
              </tbody>
      ...
      <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  ...
                  <form class="form-horizontal" action="<?php echo base_url().'admin/struktur_organisasi/simpan_struktur'?>" method="post" enctype="multipart/form-data">
                  <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-7">
                                          <input type="text" name="xguru_jabatan" class="form-control" id="inputUserName" placeholder="Jabatan">
                                      </div>
                                  </div>
      ...
      <div class="modal fade" id="ModalEdit<?php echo $id_jabatan;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  ...
                  <form class="form-horizontal" action="<?php echo base_url().'admin/struktur_organisasi/update_struktur'?>" method="post" enctype="multipart/form-data">
                  <div class="modal-body">
                              ...
                              <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                  ...
                                  <div class="form-group">
                                      <label for="inputUserName" class="col-sm-4 control-label">Jabatan</label>
                                      <div class="col-sm-7">
                                          <input type="text" name="xguru_jabatan" value="<?php echo $guru_jabatan;?>" class="form-control" id="inputUserName" placeholder="Jabatan">
                                      </div>
                                  </div>
      ...
      <div class="modal fade" id="ModalHapus<?php echo $id_jabatan;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  ...
                  <form class="form-horizontal" action="<?php echo base_url().'admin/struktur_organisasi/hapus_struktur'?>" method="post" enctype="multipart/form-data">
                  <div class="modal-body">
                                 <input type="hidden" name="id_jabatan" value="<?php echo $id_jabatan;?>"/>
                   <input type="hidden" value="<?php echo $photo;?>" name="gambar">
